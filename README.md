Developing a Todo application using React for the frontend. This project aims to familiarise with the fundamentals of React, state management, and interacting with APIs.
React.js Todo App
